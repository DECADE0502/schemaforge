...
- 旧兼容路径：`schemaforge/workflows/schemaforge_session.py`、`main.py --orchestrated`

## 本轮已验证

- `python -m pytest -q` -> `1550 passed`
...
- 旧 `SchemaForgeSession` 公开 API 已冻结，并有回归测试防止继续扩张
...
- 旧兼容路径还在，只是已经被明确标成兼容层

## 推荐阅读顺序

1. `docs/schemaforge-handoff-2026-03-08.md`
2. `flow/schemaforge-implementation.md`
3. `flow/schemaforge-tasks.md`
4. `flow/schemaforge-review-log.md`
