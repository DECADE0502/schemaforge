...
def analyze_datasheet_text(
    ...
    try:
        ...
        if parsed is None:
            return ToolResult(success=True, data=TextAnalysisResult(
                raw_response=raw,
                confidence=0.3,
...
def analyze_image(
    ...
    try:
        ...
        if parsed is None:
            return ToolResult(success=True, data=ImageAnalysisResult(
                raw_response=raw,
                confidence=0.3,
...
def _mock_image_analysis() -> ToolResult:
    ...
    result = ImageAnalysisResult(
        pins=[
            ...
            {"name": "VOUT", "number": "3", "type": "output", "description": "输出电压"},
        ],
        package="SOT-223",
        pin_count=3,
        confidence=0.4,
