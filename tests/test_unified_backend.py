...
class TestGUIStructure:
    ...
    def test_gui_design_imports_engines(self):
        ...
        has_engine = "ClassicEngineWorker" in source or "SchemaForgeEngine" in source
        has_session = "DesignSessionWorker" in source or "DesignSession" in source
        assert has_engine or has_session, (
